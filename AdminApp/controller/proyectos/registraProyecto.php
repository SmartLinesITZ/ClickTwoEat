...
$sql = mysql_query("INSERT INTO proyecto
		VALUES (null,'$nombreProyecto','$asesorExterno','$asesorInterno','$nombreEmpresa','$duenoEmpresa',
			'Calle ".$calle." #".$numero." Col. ".$colonia." C.P. ".$cp."','$calle','$numero','$colonia','$cp','$telefono',
			'Proceso','".$mesinicio." ".$anoinicio." - ".$mesfin." ".$anofin."','$mesinicio','$mesfin','$anoinicio','$anofin')",
