...
<div class="row">
	<div class="col s12">
		...
		<div class="col s10 offset-s1 card-panel">
			...
			<div class="row">
				<div class="input-field col s6">
					<input name="calle" id="calle" type="text" name="nombreplatillo" value="{{old('nombreplatillo')}}" class="validate">
					<label class="active" for="Usuario">Nombre del platillo</label>
				</div>

				<div class="row">
					<div class="input-field col s6">
						<input name="calle" id="calle" type="number" name="precio" value="{{old('precio')}}""valu class="validate">
